...
void PushButtonsTask()
{
    ...
    /*Change External DAC MAX value according to SET inputs to test immunity*/
    if(SET1_DEB_VAL)
    {
        if(SET2_DEB_VAL)
        {
            EncCfg.ExtDACMax = 0xFFFF>>3;
        }
        else
        {
            EncCfg.ExtDACMax = 0xFFFF>>2;
        }
    }
    else
    {
        if(SET2_DEB_VAL)
        {
            EncCfg.ExtDACMax = 0xFFFF>>1;
        }
        else
        {
            EncCfg.ExtDACMax = 0xFFFF;
        }
    }
    /*----------------------------------------------------------------------*/
